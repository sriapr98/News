...
public class HealthFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(!country.equals("null")) {
            url = "http://newsapi.org/v2/top-headlines?country=" + country + "&category=health&apiKey=2443647854264fa88a4908eb5daa8edc";
        }
        else {
            url = "http://newsapi.org/v2/top-headlines?category=health&apiKey=2443647854264fa88a4908eb5daa8edc";
        }
